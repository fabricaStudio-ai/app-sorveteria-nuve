      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 bg-dark z-[70] rounded-t-[3rem] max-w-md mx-auto h-[85vh] flex flex-col border-t border-white/10 shadow-[0_-20px_60px_rgba(0,0,0,0.8)]"
          >
            {/* Grabber */}
            ...
            <div className="p-8 glass-dark border-t border-white/5 rounded-t-[3rem] space-y-4 max-h-[60vh] overflow-y-auto">
              ...
              <div className="flex items-center justify-between mb-2">
                <span className="text-white/40 font-bold uppercase tracking-[0.2em] text-xs">Total do Pedido</span>
                <span className="text-3xl font-bold tracking-tighter text-primary">R$ {(total || 0).toFixed(2)}</span>
              </div>
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                >
                  {isProcessing ? (
                    ...
                    <>Pagar Online (Pix/Cartão) <CreditCard className="w-5 h-5" /></>
                  )}
                </motion.button>
